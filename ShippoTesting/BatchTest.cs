...
ShippoEnums.Statuses.VALIDATING, testBatch.Status);
        ...
        public void TestValidRetrieve()
        {
            ...
            ClassicAssert.AreEqual(
batch.ObjectId, retrieve.ObjectId);
            ClassicAssert.AreEqual(
batch.ObjectCreated, retrieve.ObjectCreated);
        }
        ...
        /*
                ...
                public void TestValidAddShipmentToBatch()
                {
                    ...
                    Batch batch = getDefaultObject();
                    ClassicAssert.AreEqual(
        batch.Status, ShippoEnums.Statuses.VALIDATING);
                    ...
                    setLive(false);
                    ClassicAssert.AreEqual(
        retrieve.BatchShipments.Count + shipmentIds.Count, newBatch.BatchShipments.Count);
                }
        */
        [Test]
        ...
        batch.Status, ShippoEnums.Statuses.VALIDATING);
                    ...
                    setLive(false);
                    ClassicAssert.AreEqual(
        retrieve.BatchShipments.Count, removeBatch.BatchShipments.Count);
                }
        */
        [Test]
        ...
        /*        [Test]
                public void TestValidPurchase()
                {
                    ...
                    ClassicAssert.AreEqual(
        ShippoEnums.Statuses.PURCHASING, purchase.Status);
                }
        */
        [Test]
        ...
        public static Batch getDefaultObject()
        {
            ...
            ClassicAssert.AreEqual(ShippoEnums.Statuses.VALIDATING, batch.Status);
            return batch;
        }
    }
}
